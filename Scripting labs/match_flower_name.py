...
def main():
    ...
    first = full_name[0].lower()
    first_name_letter = first[0]
    print("Unique flower name with the first letter: {}".format(flower_dict[first_name_letter]))
